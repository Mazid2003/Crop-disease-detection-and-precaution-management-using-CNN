...
model = tf.keras.models.load_model('C:\\Users\\USER\\Desktop\\major\\best_model.h5')

# List of class names
class_names = ['Apple___Apple_scab','Apple___Black_rot','Apple___Cedar_apple_rust','Apple___healthy',
               'Blueberry___healthy','Cherry_healthy','Cherry_Powdery_mildew',
               ...
               'Soyabean___healthy','Squash___Powdery_mildew','Strawberry___healthy',
               ...
               'Tomato___Spider_mites_Two-spotted_spider_mite','Tomato___Tomato_mosaic_virus' ,
